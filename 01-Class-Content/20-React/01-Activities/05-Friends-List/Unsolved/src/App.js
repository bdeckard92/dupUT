...
function App() {
  // Using useState, declare a new state variable 'friendsList' and set it to 'friends' from 'friends.json'
  ...
  return (
    <Wrapper>
      ...
      {/* Pass the removeFriend method and each property of a friend */}
    </Wrapper>
  );
}
