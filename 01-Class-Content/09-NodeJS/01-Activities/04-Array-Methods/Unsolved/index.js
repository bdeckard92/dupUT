// Helper function to output text in the terminal in a color
const outputColor = text => console.log(`\x1b[36m${text}\x1b[0m`);
...
// TODO: Write a for .. of loop that iterates over each song and uses the `outputColor()` method to output each song in a cyan color to the terminal.
