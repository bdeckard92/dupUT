...
* Navigate to `05-Middleware/Solved` in your command line and run `npm start`.
...
* Open `05-Middleware/Solved/views/index.handlebars` in your IDE and explain the following:
...
* Open `05-Middleware/Solved/server.js` in your IDE and explain the following:
