...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We can refer to the lesson plan, read the [Handlebars Partials docs](https://handlebarsjs.com/guide/partials.html), and stick around for office hours to ask for help.
...
* Open the browser and go to `localhost:3001` to demonstrate the following:
    ...
    * 🔑 We are greeted with the message: "Welcome to the Library! This is your first time visiting the Library!"
    
    * 🔑 After we refresh the page, we are greeted with the message: "Welcome to the Library! You have visited the Library 2 times!"
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We can refer to the lesson plan, read the [Express Sessions docs](https://www.npmjs.com/package/express-session), and stick around for office hours to ask for help.
