...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ Create the `/:num` route 

    * ✔️ Create the `icecream.handlebars` file
...
* Open `01-Ben-and-Jerrys/Solved/server.js` in your IDE and explain the following: 
    ...
    * The route to get the list of ice cream flavors is given. 
    ...
    * 🔑 We need to create a `/:num` route that will display the details for a specific ice cream flavor.

    * We will get the number from the `req.params.num` but we need to subtract 1 in order to grab the right data from the `icecreams` array.
...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ Modify `/all-pets` route

    * ✔️ Modify `/all-non-pets` route
...
* Open `02-Pets-or-animals/Solved/server.js` in your IDE and explain the following: 
    ...
    * 🔑 We need to create an object of the animals array to send over to the `index.handlebars` file in the `/all-pets` route. 
    ...
    * Then we will send only those animals to `index.handlebars`
