# Module 14 Virtual Class: MVC

## Overview 

In today's virtual class, students will practice using Handlebars.
...
* Use Handlebars helpers to iterate through objects and render them on the page
