...
* Today's activities include hardcoded data in the `dish-routes.js` file to ease the students into using Handlebars. The next class will actually use Sequelize and MySQL to handle data logic on the back end.
