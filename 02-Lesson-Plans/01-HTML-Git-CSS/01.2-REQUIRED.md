...
In today's virtual class, students will review CSS, relative paths, and deploying to GitHub Personal Pages.
...
* Open `03-HTML-CSS/Solved/index.html` in your IDE and explain the following:
  ...
  * The body of our document is very similar to the activity from this week's first class. We filled in the content with our own information.
