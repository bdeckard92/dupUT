...
- Open `03-Stu_HTML-CSS/Solved/index.html` in your IDE and explain the following:
  ...
  - The body of our document is very similar to previous activity files. 
...
- Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  - 🙋 We were introduced to absolute paths in lesson 2 when contrasted with relative pathing.
...
* Navigate to `http://<you-GitHub-username>.github.io` to demonstrate the following: 
  ...
  * 🔑 If we are receiving an error or a blank page, we may need to wait a few minutes for the GitHub servers to update. We may also need to specify the path to `index.html` in the browser, for example: `http://<you-GitHub-username>.github.io/index.html`. If we need to further troubleshoot our deployment, we navigate to the Setttings of our repository, and ensure Pages is enabled and the branch is set to `main`. 
...
- Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  - 🙋 We can refer to the lesson plan, read the [GitHub Page documentation](https://pages.github.com/), and stick around for Office Hours to ask for help.
...
* Go over the [Professional README Guide](../../01-Class-Content/01-HTML-Git-CSS/04-Supplemental/professional-readme-guide/README.md) briefly before they get started on their first Challenge.
