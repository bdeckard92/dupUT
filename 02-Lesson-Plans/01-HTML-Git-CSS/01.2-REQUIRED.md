# Module 01 Virtual Class (Required): HTML, CSS, and Git

## Overview

In today's required virtual class, students will review CSS, relative paths, and deploying to GitHub Personal Pages.
...
| 7:15PM | 3   | Instructor Demo: HTML + CSS       | 0:05     |
| 7:20PM | 4   | Student Do: HTML + CSS            | 0:15     |
| 7:35PM | 5   | Instructor Review: HTML + CSS     | 0:10     |
| 7:45PM | 6   | Instructor Demo: Relative Paths   | 0:05     |
| 7:50PM | 7   | Student Do: Relative Paths        | 0:15     |
| 8:05PM | 8   | Instructor Review: Relative Paths | 0:10     |
| 8:15PM | 9   | Instructor Demo: GitHub Pages     | 0:05     |
| 8:20PM | 10  | Student Do: GitHub Pages          | 0:20     |
| 8:40PM | 11  | Instructor Review: GitHub Pages   | 0:10     |
...
* Open `03-HTML-CSS/Solved/index.html` in your browser and demonstrate the following:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We used CSS positioning in lesson 3 to position the form in the hero section. We were also introduced to HTML elements in lesson 1 and used HTML elements to start building the header and footer in lesson 2.
...
* Direct students to the activity instructions found in `03-HTML-CSS/README.md`.
...
* Open `03-HTML-CSS/Solved/index.html` in your IDE and explain the following:

  * 🔑 Notice, we used the `<link>` tag in the `<head>` of our document to _link_ our stylesheet.
  ...
  * The body of our document is very similar to the activity from the Recommended Class. We filled in the content with our own information.
  ...
  <body>
    ...
    <div class="container">
      ...
      <section id="contact-info">
        <h2>Contact Info</h2>
        <ul>
          <li><strong>Email:</strong> <a href="#">myemail@gmail.com</a></li>
          <li><strong>Github:</strong> <a href="#">my Github username</a></li>
          <li><strong>LinkedIn:</strong> <a href="#">my LinkedIn profile</a></li>
        </ul>
      </section>
    </div>
  </body>
...
* Open `03-HTML-CSS/Solved/style.css` in your IDE and explain the following:
  ...
  * The other styling can be different from what is shown, which is fine!

* Ask the class the following questions (☝️) and call on students for the answers (🙋):

  * ☝️ Why do we give our `#main-bio` and `#contact-info` sections width percentages of 70 and 30?
  ...
  * 🙋 We can refer to the lessons, read the [MDN Web Docs on float](https://developer.mozilla.org/en-US/docs/Web/CSS/float), and stick around for Office Hours to ask for help.
