...
- Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 @TODO { EXPLAIN CAREER SERVICES: Career Services is here to support us through this process in the next 6 months.  }

    * ☝ What is a Career Services Milestone? 
    
    * 🙋 @TODO { CAREER SERVICES MILESTONES }
...
* Navigate to the [Career Services Milestone #1](https://sites.google.com/2u.com/careerservices-webdev/coding-milestones/milestone-1-career-services-overview).
  ...
  * If we watch the [Introduction to Career Services video](https://www.youtube.com/watch?v=Tiuil_uXxG0&feature=youtu.be), we @TODO { WHAT WILL WE LEARN? }
