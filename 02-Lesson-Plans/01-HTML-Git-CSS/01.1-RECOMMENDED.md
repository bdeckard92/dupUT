...
- ☝️ Ask the class who is looking for a change of job/career or some sort of promotion after the boot camp is complete. Most students will raise their hands.

- Point out that just completing the boot camp is not enough. Students need to prepare for job applications and interviews.

- Let students know that they'll see the Career Services milestones on their calendars and that each of these milestones is specifically tailored to becoming ready for the job search and interviewing process.

- Navigate to the Career Services site for [Milestone #1](https://sites.google.com/2u.com/careerservices-webdev/coding-milestones/milestone-1-career-services-overview).

- Take a few minutes to play the introduction to Career Services video located under *Key Takeaways* (~3 mins).

  - Link to video: [Introduction to Career Services](https://www.youtube.com/watch?v=Tiuil_uXxG0&feature=youtu.be)

- 🙋 Call on a student to read what it means to be "Employer Ready" in the *Why We're Here* section.

  - Recap that to be employer ready, students need to have created the minimum required job search materials:
  ...
  - Tell the class that students in our programs that earn employer ready status have the most success in obtaining a new position post-bootcamp.

- 🙋 Call on a student to read what it means to be "Employer Competitive" in the *Why We're Here* section.

- 🙋 Call on a student to summarize the difference between being employer ready and employer competitive.

  - Recap that to be employer competitive students are going beyond the minimum requirements and are engaging in things such as:

    ✔️ networking

    ✔️ research

    ✔️ deploying projects

    ✔️ well-crafted GitHub with ReadMe files and pinned repositories
   

- Let students know that Career Services is here to support them through this process in the next 6 months. 

- Slack out the link to the Career Services resources page: [http://bit.ly/CodingCS](http://bit.ly/CodingCS)
