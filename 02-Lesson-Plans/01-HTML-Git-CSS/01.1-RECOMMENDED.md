# Module 01 Virtual Class (Recommended): HTML, CSS, and Git
...
* Navigate to the [Intro to Career Services webpage](https://mycareerspot.org/intro).
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to the [Career Services website](https://mycareerspot.org/), and stick around for Office Hours to ask for help.    
