# Module { XX } Required Session: { MODULE TITLE }

## Overview 

@TODO In today's required session, { OUTLINE THE 3 KEY TOPIC AREAS FROM THE ASYNCHRONOUS CONTENT THAT ARE REINFORCED IN THIS LESSON }.
...
## Time Tracker 
@TODO THIS URL IS THE TIME TRACKERS TEMPLATE; REPLACE IT WITH THE CORRESPONDING COPY
[{ XX-MODULE-TITLE }-time-trackers](https://docs.google.com/spreadsheets/d/1kpNr77Wlds9PtXEp-WTfcpxh1qpSkTOLcwblfba12GM/edit?usp=sharing)
