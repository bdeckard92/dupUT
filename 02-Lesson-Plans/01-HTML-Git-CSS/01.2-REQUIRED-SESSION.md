...
- Open `@TODO` in your browser and demonstrate the following:
...
- Open `@TODO/folder/file` in your browser and demonstrate the following:
    ...
    - 🔑 This is a simple portfolio built using HTML and CSS. It follows accessible standards by using only one top-level section heading and two second-level headings.
