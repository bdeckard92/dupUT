...
Welcome, and thank you so much for being a part of our program! Thanks to instructors and TAs like you, we're helping thousands of students around the world achieve their professional goals and their creative dreams. You'll have plenty of time to work with these students, and their progress will astound you. Get ready! You're in for a fun ride!
...
In this week's virtual classes, you will welcome students to their first module of the Full-Stack Web Development Boot Camp. You'll walk them through the very basics of HTML, CSS, Git version control, and terminal/console commands.
...
* Git is an essential skill that employers will expect students to have on day one of their new positions. It is important to impart knowledge of the essential Git commands to help students save their work and collaborate effectively.
...
* As one of the three fundamental technologies used for web development, CSS is an important skill for students to have to style content on the page. CSS allows students to organize their code so that style is separate from content.
...
* Learn semantic HTML and the best practices for structuring HTML files.

* Structure HTML elements to satisfy specific accessibility standards that allow tools such as screen readers to explain the page's content in a meaningful way to those who have a disability like impaired vision or hearing loss.

* Follow best practices for structuring CSS files.

* Add comments to CSS files to make the code easier to read.

* Publish a webpage to the internet using GitHub Pages.
...
* Review with students the difference between a Module Project and a Challenge. A Challenge can be thought of as homework, while the Module Project is asynchronous material in Canvas. While the Module Project is not required, students are advised to be familiar with the material before attending class.
...
* DRY design pattern -- consolidating CSS selectors

* Ensuring that all links function properly

* Implementation of semantic structure of HTML elements

* Well-documented code -- including comments
...
Next week, you will review flexbox, CSS Grid, and other advanced CSS topics. If these are new to you or it's been a while, be sure to review the activities in advance.

**Important**: As students start working on their weekly Challenges, they will need to create professional READMEs for every Challenge they complete. Refer them to this [Professional README Guide](../../01-Class-Content/01-HTML-Git-CSS/04-Supplemental/professional-readme-guide/README.md) as they work on their first Challenge.

## Resources

* [GitHub Docs on generating a new SSH key and adding it to the ssh-agent](https://help.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent)

* [VS Code open in browser extension](https://marketplace.visualstudio.com/items?itemName=techer.open-in-browser)

* [Professional README Guide](../../01-Class-Content/01-HTML-Git-CSS/04-Supplemental/professional-readme-guide/README.md)

* [Git documentation on the command line](https://git-scm.com/book/en/v2/Getting-Started-The-Command-Line)
