...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/1dI5n5w5sXG4fNIKQzkQZcbhji7D1IR1zrurEuNhVyl8/edit?usp=sharing) and walk through the following slides on foundation setting: 
  ...
  * Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We can refer to the [Career Services website](https://mycareerspot.org/), and stay for Office Hours to ask for help.    
...
* Open `01-HTML/Solved/index.html` in your browser and demonstrate the following:
  ...
  * 🔑 We use anchor tags to create links for email, and GitHub and a portfolio.
...
* Open `02-HTML/Solved/index.html` in your IDE and explain the following:
...
### 3. Instructor Demo: Attributes (5 min)
...
* Take this time to help get students unblocked on any installation issues that they might be having.
