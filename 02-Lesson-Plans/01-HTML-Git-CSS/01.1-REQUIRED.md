...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/1dI5n5w5sXG4fNIKQzkQZcbhji7D1IR1zrurEuNhVyl8/edit?usp=sharing) and walk through the following slides on foundation setting: 
  ...
  * Navigate to the [Intro to career services webpage](https://github.com/coding-boot-camp/fullstack-prework/pull/80/intro).
  ...
  * Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We can refer to the [career services website](https://github.com/coding-boot-camp/fullstack-prework/pull/80/), and stay for Office Hours to ask for help.    
