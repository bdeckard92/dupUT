...
* The `02-Create-Read` activity includes a `/seed` POST route simply to make it easier to populate the database with books quickly.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We will need to use Sequelize's model class in our Challenge.
