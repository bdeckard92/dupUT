...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/1xL-SnsKxCAa4gG4ehdOVlb--xz53AtkAbMdpFxkNkoQ/edit?usp=sharing) and walk through the following slides on foundation setting: 
  ...
  * Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * ☝️ Just like with your resume, your portfolio and GitHub profile can be submitted to a Career Material Advisor for feedback. Does anybody know what benefits you receive for having these pieces submitted to a Career Material Advisor and then checked off as employer-ready by your Career Director?

    * 🙋 We are eligible for employer referral programs, industry events, and other Career Services resources.

  * Remind students that they can only access our referral programs and resources beyond their Career Director once they have submitted their resume, portfolio and GitHub profile to a Career Director and it has been marked as employer-ready. Career Material Advisors are those who can offer support in writing and developing those materials.
 
  * If students don't know who their Career Director is, they can refer to the emails they receive from the Career Director starting in week two, or you can check with your SSM. 
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We can refer to Lesson 1, read the [Sequelize Manual on Model Querying](https://sequelize.org/v5/manual/querying.html), and stick around for Office Hours to ask for help.
