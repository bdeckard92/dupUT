...
* Navigate to `02-Challenge/Master/` from the command line and run `node server.js`.
...
* Navigate to `05-Blog-Joins/Solved/` in your command line and run `npm start`. Navigate to <http://localhost:3001/> in your browser and demonstrate the following:
...
* Navigate to `01-Class-Content/14-MVC/02-Challenge/Master` from the command line and run `node server.js`
