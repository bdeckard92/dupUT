...
* Open the [Slide Deck](https://docs.google.com/presentation/d/1hrJFo5_NZzWlcXWgJyMUymoJWt2dDW1uxKy_FLhfeQE/edit?usp=sharing) and walk through the following slides on foundation setting: 
    ...
    * Ask the class the following questions (☝️) and call on students for the answers (🙋):
        ...
        * ☝️ Why should we bother adding skills like AJAX on our resume?
        ...
        * 🙋 LinkedIn! LinkedIn is a great place for recruiters and HR managers to find potential employees—these searches usually start by dropping keywords into the search function. So it's important to have a clean headline and skills section that details all the skills and interests you have.
