...
* Direct students to the activity instructions found in `03-Demo-Dynamic/README.md`.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [GitHub documentation on REST API](https://docs.github.com/en/rest), and stick around for office hours to ask for help.
...
* Announce the project groups.
  ...
  * Project ideas will be approved by the instructor in next week's first virtual class in Module 7.
...
* Since this is the first time the students will be working collaboratively, they will learn about agile development methodologies and creating GitHub issues and projects in preparation for Project 1.
