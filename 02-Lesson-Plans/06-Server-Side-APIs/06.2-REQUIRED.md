...
* Open `03-Demo_Dynamic/Solved/index.html` in your browser and demonstrate the following:
  ...
  * 🔑 In this application, we grab the root elements oif the page where we want the elements to be inserted.
...
* Direct students to the activity instructions found in `03-Demo_Dynamic/README.md`.
