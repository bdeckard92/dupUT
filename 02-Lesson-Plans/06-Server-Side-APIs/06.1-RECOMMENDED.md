...
* Open `01-Fetch/Solved/assets/js/script.js` in your browser, open the console, and demonstrate the following:
...
* Open `01-Fetch/Solved/assets/js/script.js` in your IDE and explain the following: 
    ...
    * 🔑 We use chain a `.then` function to take our response and convert it to `json()`
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 We can refer to the lesson plan, read the [MDN Documentation on Fetch](https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch), and stick around for office hours to ask for help.
...
* Direct students to the activity instructions found in `02-Response/Solved/assets/js/script.js`.
