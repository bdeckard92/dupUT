...
* Students are introduced to using fetch and public APIs in lesson 1 in the async material.

## Time Tracker

| Start  | #   | Activity Name                      | Duration |
| ------ | --- | -----------------------------------| -------- |
| 7:00PM | 1   | Introduction/Take Pulse            | 0:05     |
| 7:05PM | 2   | Everyone Do: Career Connection     | 0:20     |
| 7:25PM | 3   | Instructor Demo: Simple Fetch      | 0:05     |
| 7:30PM | 4   | Student Do: Simple Fetch           | 0:15     |
| 7:45PM | 5   | Instructor Review: Simple Fetch    | 0:10     |
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ Did anyone attempt the Code Signal algorithm?
    ...
    * Encourage students to take advantage of the CodeSignal practice because it reflects real-world online interviewing.
...
* ☝️Awesome! Now how do we check if middle point is one number or two numbers?
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 In the async material, students made a request to the GitHub API using fetch and curl.
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 In the async material, students used fetch to send a request to the GitHub API.
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 In Lesson 1, a fetch request is made to the GitHub API.
