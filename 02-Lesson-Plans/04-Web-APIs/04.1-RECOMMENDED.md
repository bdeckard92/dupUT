...
* Open `01-DOM-manipulation/Solved/script.js` in your IDE and explain the following: 
...
* Open `02-addEventListener/Solved/script.js` in your IDE and explain the following: 
