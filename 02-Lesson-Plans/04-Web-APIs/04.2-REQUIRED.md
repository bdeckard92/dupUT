...
| 8:15PM | 9   | Instructor Demo: True or False Game   | 0:05     |
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We learned about web APIs using `window` and Document Object Model. We are moving fast compared to traditional learners. It’s okay to feel overwhelmed as long as you don’t give up.
...
* Open `03-Timers/Solved/script.js` in your IDE and explain the following: 
...
* Open `04-localStorage/Solved/script.js` in your IDE and explain the following: 
...
* Open `05-True-or-False-Game/Solved/script.js` in your IDE and explain the following: 
