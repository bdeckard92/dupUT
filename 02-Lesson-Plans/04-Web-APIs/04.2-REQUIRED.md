...
* Open `04-Web-APIs/02-Challenge/Main/index.html` in your browser and demonstrate the following:
...
* Direct students to the activity instructions found in `03-Stu_timers/README.md`.
