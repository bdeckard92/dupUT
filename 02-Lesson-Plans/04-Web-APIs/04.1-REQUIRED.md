...
* Open the [Slide Deck](https://docs.google.com/presentation/d/1-3daePaDjvwnUFY_Vsio7NY9acF9DM7RablesuVAKk4/edit?usp=sharing) and walk through the following slides on foundation setting: 
	...
	* Ask the class the following questions (☝️) and call on students for the answers (🙋):
		...
		* ☝️ What actually is a whiteboard interview? Has anybody heard of this before?

		* 🙋 A whiteboard interview usually takes place in person. You'll be given a marker and asked to solve coding problems on a whiteboard in front of the interviewer/interviewing team. 

		**Note**: Point out to students that while it's called a whiteboard interview, it doesn't necessarily always involve a whiteboard. Many companies are utilizing whiteboarding techniques in other formats, perhaps using a laptop connected to a projector, or live online through a conferencing platform like Zoom.
