...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/1P8vSht6Vrp4Dljj3QEkvf8LPNSGAUAjUjnSFE9s5Rbk/edit?usp=sharing) and walk through the following slides on foundation setting: 
    ...
    * Ask the class the following questions (☝️) and call on students for the answers (🙋):
        ...
        * ☝ Last week we talked briefly about learning React and how many of the skills are transferrable to Vue or Angular. As such, you should apply to those jobs too! The same principle could be applied to MERN. Can you think of any other common coding stacks?

        * 🙋 MEAN&mdash;Mongo, Express, Angular, Node. Perhaps even using a different database like MySQL instead of Mongo, or using Python and Flask instead of Node and Express. Each component of the so-called MERN stack can be switched out for different technologies that do similar things. For each component, the skills are often transferrable.

    * Encourage students to consider applying widely to jobs even if they haven't learned all the skills in a job posting. When looking at a job posting, students can consider most things that:

        * require up to 2&ndash;3 years of experience (these positions will often hire entry-level with zero experience)

        * technologies that are similar to what we teach

        * job listings where they have covered 40-50% of the technologies listed.

    * Remind students that a list of technologies on a job posting is merely a wish list&mdash;most companies know that they won't get everything on it! 
