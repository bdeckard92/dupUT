...
* Ask the class the following questions (☝) and call on students for answers (🙋):
    ...
    * 🙋 We know that we are oging to need a new string to return, so we can initialize an empty one, along with an array of vowels to compare against later.
    ...
    * 🙋 For loop!  Use a for loop to cycle through each character in our string, treating it like an array. If the current character doesn't match something in our vowel array, then it isn't a vowel. We can concatenate that into our new string.
