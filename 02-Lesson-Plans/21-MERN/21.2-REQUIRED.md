...
In today's required virtual class, students will create GraphQL mutations, make query requests from the client side, and @TODO

## Learning Objectives

By the end of class, students will be able to:

* Create GraphQL mutations to add to the database
