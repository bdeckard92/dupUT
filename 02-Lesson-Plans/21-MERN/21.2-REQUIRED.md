...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to Lesson 4, read the [React Router docs on Getting Started](https://reactrouter.com/web/guides/quick-start), and attend Office Hours to ask for help.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can read the [Complete Guide to useEffect](https://overreacted.io/a-complete-guide-to-useeffect/) by Dan Abramov himself and attend Office Hours to ask for help.
