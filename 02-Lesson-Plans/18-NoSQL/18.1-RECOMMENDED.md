...
* Open Insomnia Core and demonstrate the following:
  ...
  * 🔑 When we make a POST request to `/submit` we format the data for a new user in JSON:
...
* Open Insomnia Core and demonstrate the following:
  ...
  * 🔑 When we make a POST request to `api/notebooks` with data for a new notebook in JSON format, a new notebook is created:
