...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/1y8Z6ffuf0Mi19429yoiazF3dBP6U3f3FOuajE8inIMg/edit?usp=sharing) and walk through the following slides on foundation setting:
  ...
  * Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 It's free to use and readily available! It is also backed by a robust developer community.

    * ☝️ Correct. It's also very easy to set up in comparison to a SQL database, and so many application drafts or proof-of-concepts are spun up using MongoDB because it is quick to do so. 

  * Let students know that while NoSQL databases aren't quite as popular as SQL databases, they are quickly rising in popularity, and they're frequently used with social media platforms. Having a good knowledge of how to use both in application development helps make them more marketable!
