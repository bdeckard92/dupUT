...
* Let students know that you will now do a short activity that lets them practice writing a user story.
...
* Let students know that you will transition to talking about GitHub projects, beginning with introducing a type of project management tool called a Kanban board.
