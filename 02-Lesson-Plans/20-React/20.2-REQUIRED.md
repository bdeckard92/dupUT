...
* Open `03-Hooks-useEffect/Solved` in your IDE and demonstrate the following:
  ...
  * 🔑 First, we will need to copy the [src](../../01-Class-Content/20-React/01-Activities/03-Hooks-useEffect/Solved/src) folder and paste it into the [00-React-App](../../01-Class-Content/20-React/01-Activities/00-React-App) app.
...
* Open `04-Conditional-Rendering/Solved` in your IDE and demonstrate the following:
  ...
  * 🔑 Again, we will need to copy the [src](../../01-Class-Content/20-React/01-Activities/04-Conditional-Rendering/Solved/src) folder and replace the `src` folder in the [00-React-App](../../01-Class-Content/20-React/01-Activities/00-React-App) app with this one.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 The `useState()` hook along with HTML form elements.
  ...
  * 🙋 We need to state to track the users information. We will need to create untility functions in order to validate user information.
