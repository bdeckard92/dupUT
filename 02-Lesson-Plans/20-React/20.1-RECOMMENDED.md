...
* Open your IDE and review the solution to the CodeSignal algorithm:
    ...
    * The algorithm is called `missingOnes`. We are given an input string, `s` and we are asked to replace each digit to the corresponding number of ones (1s).
...
* Ask the class the following questions (☝) and call on students for answers (🙋):
    ...
    * 🙋 We will want a placeholder to hold the new string while we look through the original string and replace any digits with ones.
