...
* Open `02-Webpack/Solved/index.html` in your IDE and explain the following: 
    ...
    * 🔑 In the `index.html` file, we change the JavaScript script tag right before the `</body>` tag to use `dist/bundle.js`
...
* Open `02-Webpack/Solved/package.json` in your IDE and explain the following: 
    ...
    * 🔑 Finally we add the scripts to run webpack with the `--watch` option.
