...
* Open `01-Actions-Reducers/Solved` in your IDE and demonstrate the following:
    ...
    * 🔑 Similar to Module 20, today we will be using the provided [00-React-App](../../01-Class-Content/22-State/01-Activities00-React-App) app for all of our activities. 
...
* Open `02-Test-Reducers/Solved` in your IDE and demonstrate the following:
    ...
    * 🔑 Navigate to the [00-React-App/client](../../01-Class-Content/22-State/01-Activities00-React-App/client) directory in your command line and run `npm run test`.
