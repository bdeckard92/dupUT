...
* Open `02-Consumers/Solved` in your IDE and demonstrate the following:
  ...
  * 🔑 The function will receive the current context value and return a React node. Consider showing students the example found in the [React Docs on Context.Consumer](https://reactjs.org/docs/context.html#contextconsumer).
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We created tests for our components in Lesson 1. A practice that we should do in the future.
