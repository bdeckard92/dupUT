...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/1BmyoxhAugArTWcg5NVtZOaDJ3YJX4g12vi_k0B9lZRY/edit?usp=sharing) and walk through the following slides on foundation setting: 
    ...
    * This week, students will learn about global state management using the React Context API and Redux. Let them know that global state isn't always necessary for smaller applications, but knowing how to work with it will give them a competitive advantage when applying for jobs, as it is very common at many companies.

    * This is also the last week that students will see any async content from Career Services. Remind them that by now they should have completed:
    ...
    * Ask the class the following questions (☝️) and call on students for the answers (🙋):
        ...
        * 🙋 Employer-ready means that you have completed the required professional materials as laid out by Career Services. For web developers, this means having:
    ...
    * Remind students that they need to submit all of these materials to a Career Material Advisor (CMA) via Canvas/BootcampSpot (depending on your class) in order to have them approved. Once they are all approved, students should check about employer-ready status with their Career Director.

    * We know from our own data that students who put in the work to become employer-ready and open up referrals and other Career Services resources are among the most successful in job placement rates! 
