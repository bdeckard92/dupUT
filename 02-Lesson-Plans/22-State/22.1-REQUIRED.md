...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/1BmyoxhAugArTWcg5NVtZOaDJ3YJX4g12vi_k0B9lZRY/edit?usp=sharing) and walk through the following slides on foundation setting: 
    ...
    * Remind students that they need to submit all of these materials to a Career Material Advisor (CMA) via Canvas or BootcampSpot (depending on your class) in order to have them approved. Once they are all approved, students should check about employer-ready status with their Career Director.
