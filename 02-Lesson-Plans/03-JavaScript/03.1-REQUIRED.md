...
* Open the [Slide Deck](https://docs.google.com/presentation/d/1uz-GJ6vwTDSJNxfYw7l9FEAc6ZwTxXD7dcOxQC_sZB4/edit?usp=sharing) and walk through the following slides on foundation setting: 
	...
	* Ask the class the following questions (☝️) and call on students for the answers (🙋):
		...
		* 🙋 Someone from Human Resources or a recruiting agency will hold a brief 10&ndash;15 minute phone call interview to give an overview of the role, ask about experience, and oftentimes salary expectations.
