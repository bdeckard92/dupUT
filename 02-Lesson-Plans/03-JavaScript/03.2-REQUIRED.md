...
In today's virtual class, students will review functions, scope, objects and the `this` keyword. The upcoming challenge will also be introduced. 
...
* Open `04-Scope/Solved/index.html` in your IDE and demonstrate the following:
  ...
  * A variable in the global scope can be used throughout your code in any function or script. Both of the following functions have access to the value stored in the variable `Shout`:
...
* Direct students to the activity instructions found in `04-Scope/README.md`.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to the lessons, read the [MDN Web Docs on scope](https://developer.mozilla.org/en-US/docs/Glossary/Scope), and stick around for Office Hours to ask for help.
...
* Open `05-Object-This/Solved/script.js` in your IDE and demonstrate the following:
  ...
  * When we use `this` inside an object like `child`, the keyword `this` belongs to that object and is used to refer to the object's properties, as shown in the following example:
  ...
  * Inside an object's method, `this` refers to the object that the method belongs to. Because `initialInvestment` belongs to the `investor` object in the following example, `this` refers to the value of `initialInvestment` inside the `investor` object, or 5000. 
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We have used objects and the `this` keyword in lesson 3.
  ...
  * 🙋 We declare an object using `var`. An object contains a list of properties and methods. The `this` keyword refers to the object it belongs to, allowing us to refer to other properties and methods inside the object. 
...
### 11. Instructor Review: Scope (10 min) 
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to the lessons, read the [MDN Web Docs on this](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/this), and stick around for Office Hours to ask for help.
