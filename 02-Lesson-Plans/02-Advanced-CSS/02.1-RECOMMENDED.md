...
* Open `01-Flexbox-Cards/Solved/assets/css/style.css` in your IDE and explain the following:
  ...
  * 🔑 We also use flexbox to create columns instead of rows. To achieve this, we add the `display` and `flex-direction` rules to our `.flex-item` selector under all the already provided CSS rules.
