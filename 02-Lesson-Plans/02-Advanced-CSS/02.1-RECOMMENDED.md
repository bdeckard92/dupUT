...
In today's recommended virtual class, we to focus on flexbox and media queries. We will do an activity on each to help solidify concepts covered early in this module.
...
- Ask the class the following question (☝️) and call on students for the answer (🙋):
    ...
    * ☝ What are some resources for getting inspiration when building our portolios?
  ...
  * Use student reponses to facilitate discussion on creating an appealing portolio. If students don't share examples, use one of the resources above.
