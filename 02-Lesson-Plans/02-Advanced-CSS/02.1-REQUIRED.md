...
In today's virtual class, students will focus on wireframing and using flexbox.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Wikipedia page on website wireframes](https://en.wikipedia.org/wiki/Website_wireframe), and stay for Office Hours to ask for help.
