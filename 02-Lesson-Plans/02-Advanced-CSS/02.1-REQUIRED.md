...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to the lessons, read the [Wikipedia page on website wireframes](https://en.wikipedia.org/wiki/Website_wireframe), and attend Office Hours to ask for help.
