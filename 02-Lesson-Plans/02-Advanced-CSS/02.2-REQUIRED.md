...
* Also provide students with the [mockup.png](../../01-Class-Content/02-Advanced-CSS/01-Activities/3-Stu_CSS-Grid/Images/100-mockup.png) image within the same folder.
  ...
  * Here is the mockup:
  ...
  ![The mockup displays a grid with some items spanning more rows and columns than others.](../../01-Class-Content/02-Advanced-CSS/01-Activities/3-Stu_CSS-Grid/Images/100-mockup.png)
...
* Also provide students with the [mockup.png](../../01-Class-Content/02-Advanced-CSS/01-Activities/4-Stu_Pseudo/Images/100-mockup.png) image within the same folder.
  ...
  * Take the starter code and use pseudo-classes to make the page resemble the mockup presented below:
    ...
    ![The mockup shows that different styles are applied to specific HTML elements on the page](./../01-Class-Content/02-Advanced-CSS/01-Activities/4-Stu_Pseudo/Images/100-mockup.png)
