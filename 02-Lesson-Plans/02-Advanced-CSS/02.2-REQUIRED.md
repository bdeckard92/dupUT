...
* Open [Module 2 Challenge](../../01-Class-Content/02-Advanced-CSS/02-Challenge/Master/index.html) in your browser and demonstrate the following:
...
* Use the prompts and talking points below to demonstrate the following key (🔑) points:
  ...
  * ✔️ CSS Grid allows for layouts with varying sizes of grid items

  * ✔️ Grid container

  * ✔️ Specify size of elements

* Open [3-Stu_CSS-Grid](../../01-Class-Content/02-Advanced-CSS/01-Activities/3-Stu_CSS-Grid/Solved/GridDemo.html) in your browser and demonstrate the following:
...
* Direct students to the activity instructions found in [3-Stu_CSS-Grid](../../01-Class-Content/02-Advanced-CSS/01-Activities/3-Stu_CSS-Grid/README.md).
...
* Use the prompts and talking points below to review the following key (🔑) points:
  ...
  * ✔️ Small amount of CSS to achieve basic layout

  * ✔️ Specifying sizes of elements

  * ✔️ Selectors to target specific elements

* Open [3-Stu_CSS-Grid](../../01-Class-Content/02-Advanced-CSS/01-Activities/3-Stu_CSS-Grid/Solved/assets/css/style.css) in your IDE and explain the following:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ What is the name of the `:nth-child` selector?

  * 🙋 A pseudo-selector. We are going to use these in our next activity.
...
* Use the prompts and talking points below to demonstrate the following key (🔑) points:
  ...
  * ✔️ Allows for highly specific selections

  * ✔️ Are used like any other selector

  * ✔️ Make for highly custom styling.

* Open [4-Pseudo Solved](../../01-Class-Content/02-Advanced-CSS/01-Activities/4-Stu_Pseudo/Solved/index.html) in your browser and demonstrate the following:
...
* Direct students to the activity instructions found in [4-Pseudo](../../01-Class-Content/02-Advanced-CSS/01-Activities/4-Stu_Pseudo/README.md).
...
* Use the prompts and talking points below to review the following key (🔑) points:
  ...
  * ✔️ Pseudo-classes allow for highly specific styling

* Open [4-Pseudo](../../01-Class-Content/02-Advanced-CSS/01-Activities/4-Stu_Pseudo/Solved/index.html) in your IDE and explain the following:
...
* Use the prompts and talking points below to demonstrate the following key (🔑) points:
  ...
  * ✔️ We can store CSS rule value within variables

  * ✔️ Attach variables to root so available to whole document.

* Open [5-CSS-Variables](../../01-Class-Content/02-Advanced-CSS/01-Activities/5-Stu_CSS-Variables/Solved/index.html) in your browser and demonstrate the following:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We extract the colors out of our CSS rules and place them in 
...
* Use the prompts and talking points below to review the following key (🔑) points:
  ...
  * ✔️ CSS variables let us easily store rule values we would like to apply.

  * ✔️ We apply them to the root so they are available to the entire document.

* Open [5-Stu_CSS-Variables](../../01-Class-Content/02-Advanced-CSS/01-Activities/5-Stu_CSS-Variables/Solved/assets/css/style.css) in your IDE and explain the following:
  ...
  * We take the #F9EDED and place it into a variable named `--light`. Replacing #F9EDED everywhere with the variable name.
  ...
  * We do the same with #337EAA ,#1D6768 , #29364F, #181B26, and place them into `--light-blue`, `--sapphire`, `--dark-blue`, `--dark` respectively. We then replace all corresponding occurences of the hex codes with the new variable names.
