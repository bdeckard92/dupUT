...
* Open `03-Responsive-Design/Solved/index.html` in your browser and explain the following:
  ...
  * This activity implements a responsive design when we use device mode in our chrome developer tools.
  ...
  * For this activity, the majority of the code is already written for you. You will be taking a look at the CSS file included with the activity and adding some codes to describe the functionality of specific CSS properties that exist in the file.
