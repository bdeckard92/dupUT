...
* The last activity of the class, `02-Callback-Queue`, uses a `while` loop to create a blocking process that makes the page unresponsive and slow to load. Students may need to refresh their browsers to demonstrate the blocking effect.
