...
* Spend some time at the end of class to review GitHub gists, which will be used for their Challenge.
...
* This module is very different from previous modules. Likewise, the Challenge for this module is also very different. Instead of a coding activity, it is writing a GitHub gist explaining regex. Take some time to review the Challenge.

* Open the [README.md](../../01-Class-Content/17-CS/02-Challenge/README.md) for this week's Challenge and review the following:
