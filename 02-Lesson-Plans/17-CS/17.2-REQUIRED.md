...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We learned about the computer science behind JavaScript, including performance measurement, data structures, and algorithms. We also practiced describing our problem-solving process through pseudocoding. We went over closures, factory functions, and event delegation. We are moving fast compared to traditional learners. It’s okay to feel overwhelmed as long as you don’t give up.
...
* For this challenge, instead of creating a repository on GitHub, students will create a gist. Although it is new to the students, reassure them that it is easy and not so different from creating README markdown files that they are used to creating.
...
* Open <http://localhost:3000/> in a browser and demonstrate the following:

    * You are going to build a Fitness Tracker. You are already given the front end code. You will create a MongoDB database with a Mongoose schema and handle routes with Express.

    * The user will be able to create a new workout plan and add exercises to the plan.

* Ask the class the following questions (☝️) and call on students for the answers (🙋):

    * ☝️ What are we learning?

    * 🙋 You are learning about the popular noSQL database system, MongoDB. 

    * ☝️ How does this project build off or extend previously learned material?

    * 🙋 This app will handle routes with Express. It is also going to use a library called Mongoose, which is essentially the Mongo version of an ORM. 
