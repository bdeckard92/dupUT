...
* Direct students to the activity instructions found in `03-Recursion/README.md`.
...
* Open `03-/Solved/index.js` in your IDE and explain the following:
  ...
  * 🙋 We can refer to Lesson, read about the [Fibonacci sequence](https://www.mathsisfun.com/numbers/Fibonacci-sequence.html) and the [MDN docs on recursive functions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions#Recursion), and stay for office hours to ask for help.
