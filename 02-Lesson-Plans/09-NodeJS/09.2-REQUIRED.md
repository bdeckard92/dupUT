...
* Run `01-Class-Content/09-NodeJS/02-Challenge/Master/index.js` from the command line and demonstrate the following: 
...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ Don't use arrow functions when working with object methods
...
* Run `01-Class-Content/10-OOP/02-Challenge/Master/app.js` from the command line and demonstrate the following: 
