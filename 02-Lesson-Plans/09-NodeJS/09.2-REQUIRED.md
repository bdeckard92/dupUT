...
* Navigate to `04-Functional-Loops/Unsolved/` in your command line and run `node map.js` to demonstrate the following: 
...
* Navigate to `04-Functional-Loops/Unsolved/` in your command line and run `node filter.js` to demonstrate the following: 
