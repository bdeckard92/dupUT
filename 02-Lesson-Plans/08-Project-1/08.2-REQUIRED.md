...
* You will need to demonstrate the Module 09 Challenge. You may want to familiarize yourself with it prior to class.
...
* Run `01-Class-Content/09-NodeJS/02-Challenge/Master/index.js` from the command line using `node index.js` and demonstrate the following: 

    * The upcoming challenge is a Good README generator for our projects. 

    * We are prompted for information about our project. 

    * The application generates a Markdown file that we can use in our projects. 
