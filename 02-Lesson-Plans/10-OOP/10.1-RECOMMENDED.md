# Module 10 Virtual Class (Recommended): Object-Oriented Programming (OOP)
...
* Ask the class the following questions (☝) and call on students for answers (🙋):
    ...
    * ☝ What happens once we do get a number that is prime?
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 Although we won't directly use constructor functions in the upcoming Challenge, we will use ES6 classes, which use the `this` keyword. 
