 ...
 *  Open `02-Pass-Tests/Solved/algo.js` in your IDE and explain the following: 
    ...
    * 🔑 When we write our code, we start by thinking about the steps needed to make our tests pass. It is a good idea to write these steps as comments in our code.
    ...
    * 🔑 To check if our code solution passes the test, we run 'npm run test' and refactor as needed. 
