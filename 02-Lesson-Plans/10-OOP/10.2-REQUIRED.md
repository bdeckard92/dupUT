...
* Be sure to prepare and review the activities before your class begins. Try and anticipate questions students might have.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 Because many employers will require programming in TDD, knowing how to write good unit tests will be crucial to your career.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We used mocks in Lesson 2. Mocking is part of Test Driven Development and another way we can use to gain insight on the code's behavior to help us write more durable code.

  * ☝️ How does this activity equip us for the challenge?

  * 🙋 When we use the `spyOn` method, we have a way to track existing functions and the behavior of the code. Although not required, this is a useful feature that we can use to test the functionality of the Challenge code. Learning mocking also helps us think about the behavior and outcomes of the code. This will help us write better, more predictable code as developers.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to Lesson 2, read the [Jest API documentation on spyOn()](https://jestjs.io/docs/en/jest-object#jestspyonobject-methodname), and stay for office hours to ask for help.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 The challenge uses ES6 Classes for the `Employee`, `Manager`, `Engineer`, and `Intern`.

  * ☝️ How would we build this?

  * 🙋 We will declare a class using the `class` keyword and use the constructor method to initiate the object. We can also add methods to add functionality to the class object.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to Lesson 5, read the [MDN docs on Classes](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes), and stay for office hours to ask for help.
...
* Navigate to `05-Multiple-Classes/Solved/` in your command line and run `node index.js` to demonstrate the following:
  ...
  * 🔑 In this command line app, whe have built an interface for a store called Big Al's Toy Barn. Taking a look at the output, it looks like we might need to have more than one class to create blueprints for the objects.

* Navigate to `05-Multiple-Classes/Solved/toy.js` in your IDE to demonstrate the following:

  * 🔑 Let's start small. Big Al's toy store will need to have toys. In addition, each toy needs to have a name, a price, and a count.
...
* Navigate to `05-Multiple-Classes/Solved/store.js` in your IDE to demonstrate the following:
  ...
  * 🔑 Now to sell the toys, we need a blueprint for Big Al's store. We declare a store class, initialize it with a constructor, and give it some methods that will be used to perform some store-related tasks.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 For the challenge, we will be required to create multiple classes and organize the code to maintain separation of concerns. The code is easier to navigate if we give each class a clear responsibility.
...
* Open `05-Multiple-Classes/Solved/index.js` in your IDE and explain the following:
  ...
  * 🔑 We put it all together in the `index.js` file. First, we make sure the Store class and the toys are imported
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to Lesson 5, read the [MDN Web Docs on classes](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes), and stay for office hours to ask for help.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 You will need to know ES6 Classes and understand how to read the test outputs to fix the code to make them pass.
