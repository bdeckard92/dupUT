...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to Lesson 5, read the [MDN docs on Classes](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes), and attend Office Hours to ask for help.
