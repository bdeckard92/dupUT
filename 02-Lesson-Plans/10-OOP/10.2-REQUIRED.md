...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 When we use the `spyOn` method, we have a way to track existing functions and the behavior of our code. Although not required, this is a useful feature that we can to test the functionality of our Challenge code. Learning mocking also helps us think about the behavior and outcomes of our code. This will help us write better, more predictable code as developers.
