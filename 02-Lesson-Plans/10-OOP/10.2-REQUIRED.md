...
* If you see your students struggle with the activities or get frustrated, encourage them and let them know these are hard topics to understand. With time and practice, it will get easier and will make them more employer-competitive in the end! If you are comfortable doing so, share your own struggle and/or personal experiences learning and working with OOP.
...
* Navigate to `02-Challenge/Master` in your command line and run `node app.js` to demonstrate the following: 
...
* Navigate to `01-Class-Content/11-Express/02-Challenge/Master/` in your command line and run `node server.js` to demonstrate the following:
