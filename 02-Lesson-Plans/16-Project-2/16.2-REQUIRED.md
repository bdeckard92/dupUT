...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We are learning to communicate technical knowledge to others by writing a tutorial that explains Regular Expression, or regex. Whether it is in writing, like a tech blog, or in speech, like during a technical interview, the ability to clearly explain difficult technical concepts is an important skill to have as a developer. 
