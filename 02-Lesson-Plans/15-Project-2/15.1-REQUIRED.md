...
In today's virtual class, students will review Agile methodologies and git workflow, like creating a repository, branches, and pull requests. Students will also use this time to work on their group projects. 
