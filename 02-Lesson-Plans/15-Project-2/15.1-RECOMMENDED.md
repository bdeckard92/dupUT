# Module 15 Virtual Class (Recommended): Project 2
...
* In today's class you will review Agile methodologies and git workflow from Module 7, if the students need the review.
...
* Ask the students if they would like a brief review of Agile methodologies that was covered in Module 7 during the first project. If students don't need this review, skip to the next review on "Create a Repository".

* If students would like a review, use the [Project 1 Slide Deck](https://docs.google.com/presentation/d/1BFQmjVz7UDlGclA6I7MVow-fF4ppEB6AxzaxAm7nQIk/edit?usp=sharing) from Module 7 but skip the last slides 27-32 that are specific to Project 1. Use the question prompts to facilitate the following discussion:

  * **What is a project?**: We're about to begin our second project. But first, how do we define a project?
...
* Ask the students if they would like a brief review of creating repositories in GitHub that was covered in Module 7 during the first project. If students don't need this review, skip to the next review on "Branches & Pull Requests".
