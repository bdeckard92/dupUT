...
* It's important that students understand that Bootstrap is simply a large stylesheet, and that they already have a lot of the skills needed to use it. If students struggle with certain concepts, try to jog their memory of learning CSS and suggest that they use Chrome DevTools to decipher the styles being used.

* Reiterate often that, like CSS, using Bootstrap classes requires a bit of trial and error to achieve the intended design and layout. Encourage students to try out different combinations of classes to become more comfortable with the process and learn more about their personal preferences.
