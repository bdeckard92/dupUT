...
This session reviews Bootstrap and jQuery basics. Students will use the Bootstrap grid layout and components to quickly scaffold a UI, as well as perform time and date conversions using Moment.js. Students will also build a "to do list" application that is very similar to their challenge assignment. 
...
* MomentJS is first introduced in Lesson for where students are tasked with adding due date audits to the Taskmaster Pro webpage.
...
| 7:45PM | 6   | Instructor Demo: MomentJS                     | 0:05     |
| 7:50PM | 7   | Student Do: MomentJS                          | 0:15     |
| 8:05PM | 8   | Instructor Review: MomentJS                   | 0:10     |
...
### 6. Instructor Demo: Moment JS Exercises (5 min) 
...
### 7. Student Do: Moment JS Exercises (10 or 15 min) 

* Divide students into breakout rooms.

* Direct students to the activity instructions found in `/04-MomentJS`.
...
### 8. Instructor Review: Moment JS Exercises (10 min) 
...
* Open `/04-MomentJS/Solved/index.html` in your IDE and explain the following: 
    ...
    * 🔑 We then convert our `randomDate` to to the "MM/DD/YYYY" using `moment`.
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 We can refer to the lesson plan, read the [Moment.js docs](https://momentjs.com/docs/), and stick around for office hours to ask for help.
