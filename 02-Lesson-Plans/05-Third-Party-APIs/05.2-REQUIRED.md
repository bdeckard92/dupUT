...
* Direct students to the activity instructions found in `03-Bootstrap-Layout/README.md`.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can automatically size columns with simple `col` classes and reorder them, amongst many other things!
	...
	* 🙋 We can refer to Lesson 2, read the [Bootstrap documentation on the grid](https://getbootstrap.com/docs/4.5/layout/grid/), and attend Office Hours to ask for help. Use the Bootstrap examples provided in the documentation to give yourself a starting point, then continue to tweak the class names to try and configure different layouts. Having a good understanding of CSS flexbox properties will ultimately be the best way to learn it too.
...
* Open `04-Bootstrap-Utilities/Solved/index.html` in your browser and demonstrate the following:
	...
	* 🔑 The background color of the page is dark while the background color of the form is white.

	* 🔑 The text color of the header on the page is white.

	* This was implemented by using Bootstrap utility classes.
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 We will be able to use Bootstrap utility classes to style our components.
...
* Direct students to the activity instructions found in `04-Bootstrap-Utilities/README.md`.
...
* Open `04-Bootstrap-Utilities/Solved/index.html` in your IDE and explain the following:
  ...
  * 🔑 We can center a page's content vertically and horizontally by making the page have a minimum height set to the height of the page and making it a flexbox. We also apply a dark background.
  ...
  * 🔑 Then we added classes to center the header and make it white.
...
* Open `05-jQuery-UI/Solved/index.html` in your browser and demonstrate the following:
	...
	* 🔑 When typing a skill name, the word is autocompleted before I finish typing the full word.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We used jQuery UI to convert Todo lists into Sortables in Lesson 3.
    ...
    * 🙋 We will need to read the jQuery UI documentation to understand how to use the various jQuery UI widgets and interactions.
...
* Direct students to the activity instructions found in `05-jQuery-UI/README.md`.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 The draggable interaction allows you to move an item anywhere on the screen. The droppable interaction is similar, but you need to drag the item and drop it on a target.
    ...
    * 🙋 We can refer to Lesson 3, read the [jQuery UI demos](https://jqueryui.com/demos/), and attend the Office Hours to ask for help.
