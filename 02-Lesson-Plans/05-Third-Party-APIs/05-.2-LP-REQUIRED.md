...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 We learned how to use third-party APIs, such as Bootstrap, jQuery and Moment.js.
    ...
    * 🙋 We are moving fast compared to traditional learners. It’s ok to feel overwhelmed as long as you don’t give up.
