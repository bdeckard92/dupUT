...
In today's virtual class, students will learn about click events and event delegation.
...
* Open `01-Click-Events/Solved/index.html` in your browser and demonstrate the following:
  ...
  * 🔑 This is a password generator. When we click on the "Generate Password" button, we see a 15-character password generated.

  * 🔑 However, in your student activity, there is a bug in the `script.js` file that is preventing the button from working correctly. You'll need to find and fix that bug.
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
  ...
  * 🙋 We should check what event listener is on the button.
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
  ...
  * 🙋 We can refer to Lesson 1, read the [jQuery documentation on mouse events](https://api.jquery.com/category/events/mouse-events/), and stay for Office Hours to ask for help.
...
* Open `02-Event-Delegation/Solved/index.html` in your browser and demonstrate the following:
  ...
  * 🔑 When we click on the Remove button, the item is removed from the page.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to Lesson 1, read the [jQuery documentation on event delegation](https://learn.jquery.com/events/event-delegation/), and stay for Office Hours to ask for help.
