...
* Open the lesson [slide deck](https://docs.google.com/presentation/d/1suBgogND_v6gyYMN-GnJMXQdSyZ5zed5H0-_XDMV71g/edit?usp=sharing) and walk through the following slides on foundation setting: 
  ...
  * Students are "heads down" now as they focus on understanding JavaScript, Web APIs and third-party APIs. It's a lot. This intense concentration might lead them to forget how important is it to keep on top of Career Services content.

  * Remind students to complete the following employer-ready and employer-competitive tasks assigned to them in the weekly Career Connection:

    * Enhance their portfolio using jQuery. Can they animate something using the jQuery animation library? Or they might choose to implement another jQuery functionality that they've learned this week.

    * The Technical Skills section of their resume should now proudly display jQuery next to HTML and CSS. Companies still frequently use jQuery, so it's important to let them know that they can use it.
