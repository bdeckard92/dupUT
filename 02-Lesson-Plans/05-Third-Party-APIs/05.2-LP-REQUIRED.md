...
Add today's algorithm to the class repository prior to class. Encourage students to solve it during office hours, then review. 
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 @TODO alternative approaches; relaxing constraints.

    * ☝️ Did anyone feel stuck this week? How did you get unstuck?

    * 🙋 There are a lot of approaches to getting unstuck. Rather than getting lost in search results, consult the official documentation first. Then ask for help from instructional staff. Study groups are also a great way to get unstuck because explaining your problems to someone else often reveals their solution. 
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 It's important to do as much of the lesson material prior to class to be fully prepared to start the challenge.
