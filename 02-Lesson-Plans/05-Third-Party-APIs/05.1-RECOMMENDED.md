...
* In the async material, Bootstrap is first introduced in Lesson 3 where students are tasked with adding Bootsrap classes to match a mock up of the Taskmaster Pro webpage. jQuery is introduced in Lesson 4 where students are tasked with adding drag and drop functionality to the Taskmaster Pro webpage.
...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
    ...
    * 🙋 We used this to create four responsive columns for tasks that were either "To do", "In progress", "In Review", or "Done", in Module 5 Lesson 3.
