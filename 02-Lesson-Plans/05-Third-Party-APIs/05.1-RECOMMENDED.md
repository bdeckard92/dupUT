...
* At this point, your students are head down and focusing on understanding JavaScript, Web APIs and now 3rd-party APIs too. It's a lot. And with this, comes forgetting how important is it to keep on top of Career Services content—after all, the goal is a new career, right?
...
* In this week's Career Connection, we asked students to complete a CodeSignal drill. 
    ...
    * Link to drill: https://app.codesignal.com/public-test/qL7KK4o6KBSgmdqBw/rDz464zXxdE6dx

    * See [05.3-CODESIGNAL](./05.3-CODESIGNAL.md) for the challenge description

* 🙋 Ask students who took the time to pseudocode their answer first. You'll likely get mixed responses, but take a moment to remind students of the importance of pseudocoding. 

  * If needed, review what it is and why it's useful from Week 04.

* Review the solution to the CodeSignal problem and answer any questions students have about using a platform such as CodeSignal as well as anything about this actual solution.
