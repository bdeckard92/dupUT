...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/16JRBi30jrnrmm5S828oammi5IapfzVsAjSCsHsi06As/edit?usp=sharing) and review the following slides on foundation setting:
  ...
  * Students will likely feel overwhelmed with the introduction of yet another coding language this week -- SQL.
  ...
  * This week, students explored the prevalence of different types of SQL -- including MySQL, Microsoft SQL Server, PostgreSQL, and MariaDB -- by searching for local job openings on Indeed.com.

  * Ask the class the following questions (☝️) and call on students for the answers (🙋):

    * ☝️ What in-demand varieties of SQL did you find?

    * 🙋 Some in-demand varieties of SQL include MySQL, Microsoft SQL Server, PostgreSQL, MariaDB.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 You are adding another layer to your full-stack skill set. It's important to look back at what you've accomplished and acknowledge that it is a lot! It’s also okay to feel overwhelmed -- as long as you don’t give up.
...
* Open `01-SQL-Schema/Solved/schema.sql` in your IDE and explain the following:
  ...
  * 🔑 Remind students that in this activity they were encouraged to design their own tables. As a result, their tables might not resemble the demo exactly.
  ...
  * 🔑 For each column in the table, we add a data type. We set the `id` column to `NOT NULL` so that the column must always contain a value:
...
* Open the [Git documentation on git cherry-pick](https://git-scm.com/docs/git-cherry-pick) in your browser and explain the following:
