...
* Open the lesson's [slide deck](https://docs.google.com/presentation/d/16JRBi30jrnrmm5S828oammi5IapfzVsAjSCsHsi06As/edit?usp=sharing) and walk through the following slides on foundation setting: 
  ...
  * This week, students explored different flavors of SQL&mdash;including MySQL, Microsoft SQL Server, PostgreSQL, and MariaDB&mdash;and their prevalence in their local area by searching on Indeed.com.
