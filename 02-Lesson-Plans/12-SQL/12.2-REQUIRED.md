...
| 6:45PM | 3   | Instructor Demo: JOIN          | 0:05     |
| 6:50PM | 4   | Student Do: JOIN               | 0:15     |
| 7:05PM | 5   | Instructor Review: JOIN        | 0:10     |
| 7:15PM | 6   | Instructor Demo: Node Read     | 0:05     |
| 7:20PM | 7   | Student Do: Node Read          | 0:15     |
| 7:35PM | 8   | Instructor Review: Node Read   | 0:10     |
| 7:45PM | 9   | Instructor Demo: Node CRUD     | 0:05     |
| 7:50PM | 10  | Student Do: Node CRUD          | 0:20     |
| 8:10PM | 11  | Instructor Review: Node CRUD   | 0:10     |
...
* Run [05-Stu_Node-CRUD](../../01-Class-Content/12-SQL/01-Activities/05-Stu_Node-CRUD/Solved/server.js) from the command line and demonstrate the following: 
...
* Open [05-Stu_Node-CRUD](../../01-Class-Content/12-SQL/01-Activities/05-Stu_Node-CRUD/Solved/server.js) in your IDE and explain the following: 
...
* Run [13-ORM/02-Challenge/Master/server.js](../../01-Class-Content/13-ORM/02-Challenge/Master/index.js) from the command line, then visit <http://localhost:3000/api/products> in a browser and demonstrate the following: 
    ...
    * Products belong to a category and can have many tags.
