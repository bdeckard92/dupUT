...
* Navigate to `02-Challenge/Master/` from the command line and run `node index.js` to demonstrate the following: 
...
* Navigate to `01-Class-Content/13-ORM/02-Challenge/Master/` from the command line and run `node server.js`.
