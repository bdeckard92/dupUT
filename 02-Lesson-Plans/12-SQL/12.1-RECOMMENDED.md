...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 This is similar to how we loaded the `schema.sql` file from the command line in Lesson 1. We also verified the schema from the command line.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We can refer to Lesson 1, read the [MySQL documentation on common queries](https://dev.mysql.com/doc/refman/8.0/en/examples.html), and stick around for office hours to ask for help.
