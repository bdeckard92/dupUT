...
In today's virtual class, students will review setting up an Express.js application using standard GET routes as well as GET routes with parameters.
...
* Open the lesson [slide deck](https://docs.google.com/presentation/d/1RrWrrQ084PgeaYl_-N0QRQTIHyvUhwokJ-Aq3X3TwPw/edit?usp=sharing) and walk through the following slides on foundation setting: 
  ...
  **Career Connection**: Reinforce that students will use the skills they learn this week throughout their careers. It's important for them to know the "why" and "how" behind the "what." Give examples of how these skills are used on the job. If you feel comfortable, share examples of how you have used them in your professional career.
    ...
    * This week, students will receive an email from their Career Director encouraging them to start working on their resume, and next week they'll see some content in the async lessons that walks them through how to create a technical resume that's interview-ready!

    * Remind job-seeking students that it's important to complete these Career Services milestones. When they do, they get access to many more resources, such as dedicated 1:1 time with their Career Director, access to a range of online workshops, and post-boot-camp support!

    * Ask the class the following questions (☝️) and call on students for the answers (🙋):

      * ☝️ Without wanting to ask the obvious, why do we need a resume?

      * 🙋 A resume is the core document of a job search. In addition to this, we also need a portfolio and a GitHub profile.

      * ☝️ Who can help you complete your resume?

      * 🙋 A Career Material Advisor, or CMA! Once you submit your resume to Career Services online, you will be assigned a Career Material Advisor (CMA). You can receive unlimited feedback on your resume, even after graduation. We should take advantage of this resource because creating a technical resume is very different from what we might be used to.
