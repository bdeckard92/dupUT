...
* Navigate to `01-API-Endpoints/Solved/` in the command line and run `npm start` to demonstrate the following:
  ...
  * 🔑 The browser will be suffice for simple GET requests for information like this, however, in the future we will being using an application called Insomnia to make GET requests.
...
* Navigate to `01-API-Endpoints/Solved/` in your command line and run `npm install` and `npm start`.
...
* Navigate to `02-GET-Fetch/Solved` in your command line and run `npm start` to demonstrate the following:

  * 🔑 In our browser, when we visit <http://localhost:3001/>, we a page with a button to fetch pets.
  ...
  * This is an example of how we can use an Express server, along with front end JavaScript, to fetch and display data from our own API.
...
* Navigate to `02-GET-Fetch/public/index.js` in your command line and run `npm install` and `npm start`.
