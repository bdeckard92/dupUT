...
In today's virtual class, students will review Express server basics. Students will use `app.post` to handle POST requests and also build a "Star Wars API" application that will serve both API routes and HTML routes, similar to their challenge. 
